      ...
      <Card className="p-4 border border-gray-200 shadow-sm">
        ...
        <CardContent className="px-0">
          <div className="text-xl font-bold text-blue-700 leading-none">
            {formatNT(statistics.monthlyDue)}
          </div>
        </CardContent>
      </Card>
      <Card className="p-4 border border-green-100 shadow-sm bg-green-50/30">
        ...
        <CardContent className="px-0">
          <div className="text-xl font-bold text-green-700 leading-none">
            {formatNT(statistics.monthlyPaid)}
          </div>
        </CardContent>
      </Card>
      <Card className="p-4 border border-orange-100 shadow-sm bg-orange-50/30">
        ...
        <CardContent className="px-0">
          <div className="text-xl font-bold text-orange-700 leading-none">
            {formatNT(statistics.monthlyUnpaid)}
          </div>
        </CardContent>
      </Card>
      <Card className="p-4 border border-red-100 shadow-sm bg-red-50/30">
        ...
        <CardContent className="px-0">
          <div className="text-xl font-bold text-red-700 leading-none">
            {formatNT(statistics.overdueUnpaid)}
          </div>
        </CardContent>
      </Card>
    </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-green-600">
                {formatNT(statistics.totalAmount)}
              </p>
            </div>
        ...
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-green-600">{formatNT(statistics.paidAmount)}</p>
            </div>
            <DollarSign className="h-8 w-8 text-green-500" />
          </div>
        </CardContent>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-orange-600">
                {formatNT(statistics.totalAmount - statistics.paidAmount)}
              </p>
            </div>
