...
const QUICK_FILTERS: QuickFilter[] = [
  ...
  },
  {
    ...
    apply: (p) => {
      p.setDateRange("currentMonth")
      p.setSelectedStatus("unpaid")
    },
  },
  {
    label: "本月實付",
    ...
    apply: (p) => {
      p.setDateRange("currentMonthPayment")
      p.setSelectedStatus("all")
      p.setShowPaidItems(true)
    },
  },
  {
    label: "分期待付",
    ...
    apply: (p) => {
      p.setSelectedPaymentType("installment")
      p.setSelectedStatus("pending")
      p.setDateRange("all")
    },
  },
  {
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="flex items-center gap-1 bg-gray-50 rounded-md border px-2 py-1">
              ...
              <Button
                ...
                size="sm"
                onClick={goToToday}
                className="h-6 text-xs px-2 ml-0.5 text-blue-600 hover:text-blue-700"
              >
                今月
              </Button>
            </div>
