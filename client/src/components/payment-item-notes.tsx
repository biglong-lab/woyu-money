  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>{itemName} - 項目備註記錄管理</CardDescription>
      </CardHeader>
        ...
        {isAddingNote && (
          <Card className="border-2 border-blue-200 bg-blue-50/50">
            <CardHeader className="pb-4">
              <CardTitle className="text-lg">{editingNote ? "編輯備註" : "新增備註"}</CardTitle>
            </CardHeader>
            <CardContent>
              <Form {...form}>
            ...
            notes.map((note: PaymentItemNote) => (
              <Card key={note.id} className="relative">
                <CardContent className="pt-4">
                  ...
                  <div className="whitespace-pre-wrap text-gray-800 mb-3">{note.noteText}</div>
      ...
      <Dialog open={imageModalOpen} onOpenChange={setImageModalOpen}>
        <DialogContent className="w-[95vw] max-w-4xl max-h-[90vh] p-4">
