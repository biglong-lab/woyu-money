    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="border-l-4 border-l-blue-500">
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <div className="text-xs text-muted-foreground">下個月預估支出</div>
              <div className="flex items-center gap-2">
                <Progress
        ...
        <Card
          className={`border-l-4 ${
            analyticsData.riskAssessment.riskLevel === "high"
              ? "border-l-red-500"
              : analyticsData.riskAssessment.riskLevel === "medium"
                ? "border-l-yellow-500"
                : "border-l-green-500"
          }`}
        >
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <div className="text-xs text-muted-foreground">逾期風險機率</div>
        ...
        <Card className="border-l-4 border-l-purple-500">
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="text-2xl font-bold">{analyticsData.paymentPatterns.onTimeRate}%</div>
              <div className="text-xs text-muted-foreground">準時付款率</div>
        ...
        <Card className="border-l-4 border-l-orange-500">
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="text-2xl font-bold">{analyticsData.recommendations.length}</div>
              <div className="text-xs text-muted-foreground">個優化建議</div>
              <div className="flex gap-1">
                {analyticsData.recommendations.slice(0, 3).map((rec, i) => (
                  <div key={i} className={`w-2 h-2 rounded-full ${getImpactColor(rec.impact)}`} />
                ))}
              </div>
            </div>
          </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>基於歷史數據的付款金額預測分析</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>基於數據分析的個性化優化建議</CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <div
                        className={`w-2 h-2 rounded-full ${getImpactColor(recommendation.impact)}`}
                      />
