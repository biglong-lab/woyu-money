...
export function UnifiedNavigation() {
            ...
            <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
              ...
              <SheetContent side="left" className="w-80">
                <SheetHeader>
                  ...
                  <SheetDescription>選擇功能區域</SheetDescription>
                </SheetHeader>
              ...
              return (
                <Link key={item.path} href={item.path}>
                  ...
                  `}
                    ...
                    <span
                      className={`text-base font-medium ${active ? "text-gray-800" : "text-gray-500"}`}
                    >
                      {item.label}
                    </span>
                  </div>
                  ...
                  {getCurrentSectionItems()
                    ...
                    .map((item) => {
                      ...
                      return (
                        <Link key={item.path} href={item.path}>
                          <Card
                            className={`transition-all ${active ? "ring-2 ring-blue-500" : "hover:shadow-md"}`}
                          >
  ...
  const DesktopNavigation = () => (
    <div className="hidden md:block fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-200 shadow-sm z-40">
      <div className="p-4">
        <Link href="/">
          <h1 className="text-xl font-bold text-gray-900 mb-6">家庭財務管理</h1>
        </Link>
  ...
  return (
    <>
      ...
      <div className="hidden md:block md:ml-64">{/* Desktop content goes here */}</div>
    </>
  )
}
