          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className="text-sm text-gray-500">{selectedDoc.originalFilename}</div>
              </div>
              ...
              <div className="space-y-4">
                ...
                {selectedDoc.status === "recognized" ? (
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-primary">
                        {selectedDoc.recognizedAmount
                          ? formatNT(parseFloat(selectedDoc.recognizedAmount))
                          : "-"}
                      </p>
                    </div>
                    <div>
                    ...
                    {selectedDoc.aiConfidence && (
                      <div>
                        ...
                        <p className="font-medium">
                          {Math.round(parseFloat(selectedDoc.aiConfidence) * 100)}%
                        </p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex flex-col items-center py-8">
                    ...
                    >
                      <RefreshCw
                        className={`h-4 w-4 mr-2 ${reRecognizePending ? "animate-spin" : ""}`}
                      />
                      重新辨識
                    </Button>
                  </div>
            ...
            <div className="space-y-2 border-t pt-4">
              ...
              <div className="text-sm text-gray-600 bg-gray-50 rounded p-3 space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    上傳時間：
                    {format(new Date(selectedDoc.createdAt), "yyyy/MM/dd HH:mm", { locale: zhTW })}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                ...
                {selectedDoc.editedAt && selectedDoc.editedByUsername && (
                  <div className="flex items-center gap-2 text-blue-600">
                    <User className="h-3 w-3" />
                    <span>
                      編輯帳號：{selectedDoc.editedByUsername}（
                      {format(new Date(selectedDoc.editedAt), "yyyy/MM/dd HH:mm", { locale: zhTW })}
                      ）
                    </span>
                  </div>
                )}
            ...
            <DialogFooter className="gap-2 flex-wrap">
              ...
              {selectedDoc.status === "recognized" && (
                <Button onClick={onArchive} className="flex items-center gap-2">
