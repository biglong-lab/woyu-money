...
export default function IntegratedPaymentAnalysisOptimized() {
  ...
  const projectBreakdown = useMemo(() => {
    const breakdown = filteredItems.reduce(
      (acc, item) => {
      ...
      <div className="container mx-auto p-4 lg:p-6 space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
          <div>
            ...
            <p className="text-muted-foreground">綜合付款分析、專案管理與統計報告</p>
          </div>
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <PaymentItemDialog
              ...
              editingItem={
                editingItem as unknown as Parameters<typeof PaymentItemDialog>[0]["editingItem"]
              }
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="dashboard" className="space-y-4">
            <DashboardCharts projectBreakdown={projectBreakdown} keyMetrics={keyMetrics} />
          </TabsContent>
