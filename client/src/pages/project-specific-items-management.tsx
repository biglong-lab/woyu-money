...
export default function ProjectSpecificItemsManagement() {
  ...
  const itemsByCategory = projectSpecificItems.reduce(
    (acc, item) => {
    ...
    <div className="space-y-6 p-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>選擇要管理專案專屬項目的專案</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-center gap-4">
            ...
            <Button onClick={handleNewItem} disabled={!selectedProject} className="ml-auto">
                  ...
                  return (
                    <div key={categoryId} className="border rounded-lg p-4 bg-gray-50">
                      <div className="flex items-center gap-2 mb-4">
                        ...
                        <span className="text-sm text-gray-500">({items.length} 個項目)</span>
                      </div>
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {items.map((item) => (
                          <div key={item.id} className="bg-white border rounded-lg p-3">
                            ...
                            {item.displayName && (
                              <p className="text-sm text-gray-600 mb-1">帳號：{item.displayName}</p>
                            )}
                          </div>
                        ))}
                      </div>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{editingItem ? "編輯專案專屬項目" : "新增專案專屬項目"}</DialogTitle>
            <DialogDescription>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="例如：088219194電話費" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="例如：帳號 088219194" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
