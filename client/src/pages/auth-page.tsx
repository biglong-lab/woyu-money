      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-muted-foreground">請登入以訪問您的付款管理平台</p>
          </div>
            ...
            <TabsContent value="login" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>輸入您的帳戶資訊以登入系統</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  {lineError && (
                    <Alert className="border-red-200 bg-red-50">
                      <AlertDescription className="text-red-800">{lineError}</AlertDescription>
                    </Alert>
                  )}
            ...
            <TabsContent value="register" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>填寫以下資訊以創建您的帳戶</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
      ...
      <div className="flex-1 bg-gradient-to-br from-blue-600 to-purple-700 p-8 text-white flex items-center justify-center">
        <div className="max-w-md space-y-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-blue-100">全方位的財務管理解決方案，讓您輕鬆掌控每一筆付款</p>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-blue-100">完整記錄每筆付款，支援多項目分類管理</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-blue-100">智能分析借貸投資收益，提供詳細報表</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-blue-100">支援匯款截圖、合約文件等檔案管理</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-blue-100">支援帳密登入與LINE登入，保障資料安全</p>
              </div>
            </div>
          </div>
        </div>
