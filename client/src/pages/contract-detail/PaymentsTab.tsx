...
const STATUS_VARIANTS: Record<PaymentItem["status"], "default" | "secondary" | "outline"> = {
  paid: "default",
  partial: "secondary",
  pending: "outline",
}
      ...
      <TableBody>
        {items.map((item) => (
          <TableRow key={item.id}>
            ...
            <TableCell>{formatNT(parseInt(item.totalAmount || "0"))}</TableCell>
            <TableCell>{formatNT(parseInt(item.paidAmount || "0"))}</TableCell>
            <TableCell>
